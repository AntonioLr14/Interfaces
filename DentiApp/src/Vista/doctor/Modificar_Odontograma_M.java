...
public class Modificar_Odontograma_M extends JPanel {
	...
	public Modificar_Odontograma_M() {
		...
		btnNewButton_4.setIcon(new ImageIcon(Modificar_Odontograma_M.class.getResource("/Vista/imagenes/diente_odon.png")));
		...
		btnNewButton_5.setIcon(new ImageIcon(Modificar_Odontograma_M.class.getResource("/Vista/imagenes/diente_odon.png")));
		...
		btnNewButton_9.setIcon(new ImageIcon(Modificar_Odontograma_M.class.getResource("/Vista/imagenes/diente_odon.png")));
