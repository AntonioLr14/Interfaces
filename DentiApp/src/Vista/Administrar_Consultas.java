...
public class Administrar_Consultas extends JPanel {
	...
	public Administrar_Consultas() {
		...
		btnNewButton_1.setBounds(475, 27, 113, 21);
		add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Consultar consulta");
		btnNewButton_2.setBounds(263, 27, 122, 21);
		add(btnNewButton_2);
		...
		separator_1.setBounds(251, 58, 146, 10);
		add(separator_1);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setBounds(460, 59, 146, 2);
		add(separator_2);
		
		JPanel panel = new JPanel();
		panel.setBounds(67, 103, 526, 193);
		add(panel);
