...
public class Administrador extends JFrame {
	...
	public Administrador() {
		...
		JLabel etiqueta_fondo_panel_exterior = new JLabel();
		
		etiqueta_fondo_panel_exterior.setBounds(0, -12, 730, 153);
		etiqueta_fondo_panel_exterior.setIcon(new ImageIcon(Administrador.class.getResource("/Vista/imagenes/fondoarriba.png")));
		
		JLabel etiqueta_fondo_panel_interior = new JLabel();
		
		etiqueta_fondo_panel_interior.setBounds(0,30, 730, 527);
		etiqueta_fondo_panel_interior.setIcon(new ImageIcon(Administrador.class.getResource("/Vista/imagenes/fondoabajo.png")));
		...
		this.contentPane.add(etiqueta_fondo_panel_exterior);
		this.contentPane.add(etiqueta_fondo_panel_interior);
		...
		boton_insertar_usuarios.addActionListener( (event) -> {
			...
			etiqueta_fondo_panel_interior.setVisible(false);
