...
import Vista.administrador.ayudas.Mostrar_ayuda;
...
public class Administrador extends JFrame {
	...
	public Administrador() {
		...
		this.boton_eliminar_especialidad.setToolTipText("Eliminar especialidad(D + E)");
		...
		this.boton_consultar_pedidos.setToolTipText("Consultar pedidos(S + P)");
		...
		this.boton_ayuda = new JButton();
		
		this.boton_ayuda.setBounds(705, 2, 20, 20);
		this.boton_ayuda.setContentAreaFilled(false);
		this.boton_ayuda.setToolTipText("Ayuda");
		this.boton_ayuda.setFocusable(false);
		
		this.boton_ayuda.setIcon(new ImageIcon(Administrador.class.getResource("/Vista/imagenes/interrogacion.png")));
		...
		this.contentPane.add(boton_ayuda);
		...
		this.popupMenu.add(opcion_ayuda);
		...
		// Establecimiento de la ayuda
		ActionListener ayuda = (event) -> {
			
			Mostrar_ayuda frame_ayuda = new Mostrar_ayuda();
			frame_ayuda.setVisible(true);
		};
		...
		this.contentPane.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent event) {
				...
				// Atajo de teclado para mostrar la ayuda
				if(combo.contains(KeyEvent.VK_CONTROL) && combo.contains(KeyEvent.VK_A)) {
		...
		opcion_ayuda.addActionListener(ayuda);
		...
		this.boton_ayuda.addActionListener(ayuda);
