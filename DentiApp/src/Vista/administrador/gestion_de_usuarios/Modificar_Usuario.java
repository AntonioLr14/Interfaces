	...
	public Modificar_Usuario() {
		...
		this.boton_aceptar.addActionListener( (event) -> {
			...
			try {
				...
				if (this.operacion_usuario.getSelectedItem().toString().equalsIgnoreCase("Modificar nombre y apellidos")) {
				...
				if (this.operacion_usuario.getSelectedItem().toString().equalsIgnoreCase("Modificar contrasena")) {
				...
				if (this.operacion_usuario.getSelectedItem().toString().equalsIgnoreCase("Modificar perfil")) {
				...
				if (this.operacion_usuario.getSelectedItem().toString().equalsIgnoreCase("Modificar estado")) {
					...
					if (this.valor_despegable_operacion.getSelectedItem().toString().equalsIgnoreCase("Alta")) {
						valor = 1;
					}
					
					if (this.valor_despegable_operacion.getSelectedItem().toString().equalsIgnoreCase("Baja")) {
						valor = 0;
					}
