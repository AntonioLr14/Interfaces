		...
		this.boton_aceptar.addActionListener( (event) -> {
			...
			try {
				...
				if (this.operacion_usuario.getSelectedItem().equals("Modificar nombre y apellidos")) {
					...
					resultado = this.dbconn.insertUpdateDelete("update Personas set Nombre = '" + this.valor_nombre_operacion.getText() + "'," +
				...
				if (this.operacion_usuario.getSelectedItem().equals("Modificar contrasena")) {
					...
					resultado = this.dbconn.insertUpdateDelete("update Usuarios set Contrasena = '" + contrasena_ecriptada + "'" +
				...
				if (this.operacion_usuario.getSelectedItem().equals("Modificar perfil")) {
					...
					resultado = this.dbconn.insertUpdateDelete("update Usuarios set Perfil = '" + this.valor_despegable_operacion.getSelectedItem().toString() + "'" +
						" where DNI = '" + this.dni_usuario.getText() + "';"
					);
				}
				...
				if (this.operacion_usuario.getSelectedItem().equals("Modificar estado")) {
					...
					resultado = this.dbconn.insertUpdateDelete("update Usuarios set Estado = " + valor + " where" +
						" DNI = '" + this.dni_usuario.getText() + "';"
					);
				}
