...
public class Asignar_Consulta extends JPanel {
	...
	public Asignar_Consulta() {
		...
		try {
			...
			ResultSet especialidades = Login_Inicio.dbconn.consulta("select Nombre from Especialidades;");
		...
		this.especialidad.addActionListener( (event) -> {
			...
			try {
				...
				Login_Inicio.dbconn.cabeceraTabla(this.citas_usuario, 
		...
		this.boton_asignar_cita.addActionListener( (event) -> {
			...
			try {
				...
				ResultSet paciente = Login_Inicio.dbconn.consulta(
				...
				ResultSet doctor = Login_Inicio.dbconn.consulta(
				...
				int inserccionval = Login_Inicio.dbconn.insertUpdateDelete(
