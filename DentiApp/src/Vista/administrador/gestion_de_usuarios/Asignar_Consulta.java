...
public class Asignar_Consulta extends JPanel {
	...
	public Asignar_Consulta() {
		...
		this.dni_nombre_usuario.setBounds(28, 32, 205, 30);
		
		this.especialidad = new Despegable_editable_theme<String>(20);
		this.especialidad.setBounds(261, 32, 205, 30);
		
		this.nombre_doctor = new Campo_texto_theme(20);
		this.nombre_doctor.setBounds(494, 32, 205, 30);
		
		this.scrollpanel = new JScrollPane();
		
		this.scrollpanel.setBounds(182, 73, 365, 130);
		...
		this.boton_asignar_cita.setBounds(559, 168, 100, 35);
