	...
	public Insertar_Usuario() {
		...
		this.boton_aceptar.addActionListener( (event) -> {
			...
			try {
				...
				resultado_persona = this.dbconn.insertUpdateDelete("insert into Personas (DNI, Nombre, Apellidos, Telefono, Correo) values ('" +
				...
				if (this.perfil_usuario.getSelectedItem().toString().equalsIgnoreCase("Administrador")) {
					...
					resultado_perfil = this.dbconn.insertUpdateDelete("insert into Usuarios (DNI, Contrasena, Perfil, Estado) values ('" +
						this.dni_usuario.getText() + "','" +
				...
				if (this.perfil_usuario.getSelectedItem().toString().equalsIgnoreCase("Doctor")) {
					...
					resultado_perfil = this.dbconn.insertUpdateDelete("insert into Doctores (DNI, ID_especialidad, Salario, Fecha_inicio_contrato, Fecha_fin_contrato) values ('" +
						this.dni_usuario.getText() + "'," +
						1 + "," +
						1000 + ",'" +
						ano + "-" + mes + "-" + dia + "'," +
				...
				if (this.perfil_usuario.getSelectedItem().toString().equalsIgnoreCase("Paciente")) {
					...
					resultado_perfil = this.dbconn.insertUpdateDelete("insert into Pacientes (DNI) values ('" +
						this.dni_usuario.getText() + "');"
					);
				}
				...
				if (this.perfil_usuario.getSelectedItem().toString().equalsIgnoreCase("Proveedor")) {
					...
					resultado_perfil = this.dbconn.insertUpdateDelete("insert into Proveedores (DNI, Direccion, Empresa) values ('" +
						this.dni_usuario.getText() + "'," +
						null + ",'" +
