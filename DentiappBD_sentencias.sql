...
insert into dentiapp.Citas (ID_paciente, ID_doctor, ID_tratamiento, Fecha_hora, Observaciones) values (1,2,1,'2024/1/30','El paciente se le ha realizado una limpieza general');
