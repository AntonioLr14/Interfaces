...
CREATE TABLE IF NOT EXISTS `dentiapp`.`tratamiento` (
  ...
  INDEX `fk_tratamiento_especialidad1_idx` (`ID_Especialidad` ASC) VISIBLE,
  CONSTRAINT `fk_tratamiento_especialidad1`
    FOREIGN KEY (`ID_Especialidad`)
    REFERENCES `dentiapp`.`especialidad` (`ID_Especialidad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `dentiapp`.`odontograma`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dentiapp`.`odontograma` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `id_diente` VARCHAR(45) NOT NULL,
  `paciente_DNI` VARCHAR(25) NOT NULL,
  `tratamiento` VARCHAR(45) NULL DEFAULT NULL,
  `fecha` DATE NULL DEFAULT NULL,
  `lugar` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_odontograma_paciente1_idx` (`paciente_DNI` ASC) VISIBLE,
  CONSTRAINT `fk_odontograma_paciente1`
